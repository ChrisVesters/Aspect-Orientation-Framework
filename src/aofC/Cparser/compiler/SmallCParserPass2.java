...
public class SmallCParserPass2 extends Parser {
	...
	public SmallCParserPass2(TokenStream input) {
		this(input, new RecognizerSharedState());
	}

	public SmallCParserPass2(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}

	public String[] getTokenNames() {
		return SmallCParserPass2.tokenNames;
	}
	...
	public final ArrayList<Node> declaration() throws RecognitionException {
		...
		SmallCParserPass2.type_specifier_return type_specifier1 = null;

		ArrayList<Node> var_decl_list2 = null;

		SmallCParserPass2.param_decl_list_return param_decl_list3 = null;

		SmallCParserPass2.id_check_return id_check4 = null;

		SmallCParserPass2.compound_stmt_return compound_stmt5 = null;
	...
	public final SmallCParserPass2.type_specifier_return type_specifier()
			throws RecognitionException {
		SmallCParserPass2.type_specifier_return retval = new SmallCParserPass2.type_specifier_return();
	...
	// dimensions] : (a= '[' ( expr )? ']' )+ ;
	public final SmallCParserPass2.array_operator_return array_operator(Node left,
			CType lefttype, boolean param) throws RecognitionException {
		SmallCParserPass2.array_operator_return retval = new SmallCParserPass2.array_operator_return();
		retval.start = input.LT(1);

		Token a = null;
		SmallCParserPass2.expr_return expr8 = null;
	...
	public final SmallCParserPass2.param_decl_list_return param_decl_list()
			throws RecognitionException {
		SmallCParserPass2.param_decl_list_return retval = new SmallCParserPass2.param_decl_list_return();
		retval.start = input.LT(1);

		SmallCParserPass2.param_decl_return a = null;

		SmallCParserPass2.param_decl_return b = null;
	...
	public final SmallCParserPass2.param_decl_return param_decl()
			throws RecognitionException {
		SmallCParserPass2.param_decl_return retval = new SmallCParserPass2.param_decl_return();
		retval.start = input.LT(1);

		SmallCParserPass2.type_specifier_return type_specifier10 = null;

		SmallCParserPass2.array_operator_return array_operator11 = null;

		SmallCParserPass2.id_check_return id_check12 = null;
	...
	// ( declaration )* ( stmt )* '}' ;
	public final SmallCParserPass2.compound_stmt_return compound_stmt(
			boolean increaseScope) throws RecognitionException {
		SmallCParserPass2.compound_stmt_return retval = new SmallCParserPass2.compound_stmt_return();
		retval.start = input.LT(1);

		ArrayList<Node> declaration13 = null;

		SmallCParserPass2.stmt_return stmt14 = null;
	...
	public final Node variable_decl(CType type) throws RecognitionException {
		...
		SmallCParserPass2.array_operator_return array_operator16 = null;

		SmallCParserPass2.id_check_return id_check17 = null;

		SmallCParserPass2.expr_return expr18 = null;
	...
	// ';' | ';' );
	public final SmallCParserPass2.stmt_return stmt() throws RecognitionException {
		SmallCParserPass2.stmt_return retval = new SmallCParserPass2.stmt_return();
		retval.start = input.LT(1);

		Token BREAK24 = null;
		Token CONTINUE25 = null;
		Token RETURN27 = null;
		SmallCParserPass2.compound_stmt_return compound_stmt19 = null;

		SmallCParserPass2.cond_stmt_return cond_stmt20 = null;

		SmallCParserPass2.while_stmt_return while_stmt21 = null;

		SmallCParserPass2.for_stmt_return for_stmt22 = null;

		SmallCParserPass2.expr_return expr23 = null;

		SmallCParserPass2.expr_return expr26 = null;
	...
	// ELSE f= stmt )? ;
	public final SmallCParserPass2.cond_stmt_return cond_stmt()
			throws RecognitionException {
		SmallCParserPass2.cond_stmt_return retval = new SmallCParserPass2.cond_stmt_return();
		retval.start = input.LT(1);

		SmallCParserPass2.stmt_return e = null;

		SmallCParserPass2.stmt_return f = null;

		SmallCParserPass2.expr_return expr28 = null;
	...
	public final SmallCParserPass2.while_stmt_return while_stmt()
			throws RecognitionException {
		SmallCParserPass2.while_stmt_return retval = new SmallCParserPass2.while_stmt_return();
		retval.start = input.LT(1);

		SmallCParserPass2.expr_return expr29 = null;

		SmallCParserPass2.stmt_return stmt30 = null;
	...
	// for_op ')' stmt ;
	public final SmallCParserPass2.for_stmt_return for_stmt()
			throws RecognitionException {
		SmallCParserPass2.for_stmt_return retval = new SmallCParserPass2.for_stmt_return();
		retval.start = input.LT(1);
		...
		SmallCParserPass2.stmt_return stmt31 = null;
	...
	public final Node for_op() throws RecognitionException {
		...
		SmallCParserPass2.expr_return expr32 = null;
	...
	public final SmallCParserPass2.arg_list_return arg_list()
			throws RecognitionException {
		SmallCParserPass2.arg_list_return retval = new SmallCParserPass2.arg_list_return();
		retval.start = input.LT(1);

		SmallCParserPass2.expr_return a = null;

		SmallCParserPass2.expr_return b = null;
	...
	// STRING );
	public final SmallCParserPass2.expr_return expr() throws RecognitionException {
		SmallCParserPass2.expr_return retval = new SmallCParserPass2.expr_return();
		retval.start = input.LT(1);

		Token STRING35 = null;
		SmallCParserPass2.expr_return e = null;

		SmallCParserPass2.pointer_id_return pointer_id33 = null;

		SmallCParserPass2.condition_return condition34 = null;
		...
		try {
			...
			// pointer_id '=' e= expr
			{
				...
				if (state.backtracking == 0) {
					...
					String name = (pointer_id33 != null ? pointer_id33.name : null);
					TableEntry entry = stb.getByName(name);
					// Is this a global declared variable?
					if (!((entry.getDepth() != 0) || (entry.getNewType() instanceof FunctionType))){
						name += "_set_";
						retval.node = new FunctionCallNode(stb.getByName(name).getID(), this.returnTypes.size());
						ArgsNode args = new ArgsNode();
						args.appendChild((e != null ? e.node : null));
						retval.node.appendChild(args);
					}
					else {
						retval.node = new AssignNode();
						CType vartype = (pointer_id33 != null ? pointer_id33.proptype
								: null);
						CType idtype = entry.getNewType();
	...
	public final SmallCParserPass2.condition_return condition()
			throws RecognitionException {
		SmallCParserPass2.condition_return retval = new SmallCParserPass2.condition_return();
		retval.start = input.LT(1);

		SmallCParserPass2.disjunction_return disjunction36 = null;
	...
	public final SmallCParserPass2.x_con_dis_return x_con_dis()
			throws RecognitionException {
		SmallCParserPass2.x_con_dis_return retval = new SmallCParserPass2.x_con_dis_return();
		retval.start = input.LT(1);

		SmallCParserPass2.expr_return a = null;

		SmallCParserPass2.condition_return b = null;
	...
	public final SmallCParserPass2.disjunction_return disjunction()
			throws RecognitionException {
		SmallCParserPass2.disjunction_return retval = new SmallCParserPass2.disjunction_return();
		retval.start = input.LT(1);

		SmallCParserPass2.conjunction_return conjunction37 = null;

		SmallCParserPass2.y_disj_return y_disj38 = null;
	...
	public final SmallCParserPass2.y_disj_return y_disj(Node left)
			throws RecognitionException {
		SmallCParserPass2.y_disj_return retval = new SmallCParserPass2.y_disj_return();
		retval.start = input.LT(1);

		SmallCParserPass2.y_disj_return e = null;

		SmallCParserPass2.x_con_dis_return x_con_dis39 = null;
	...
	public final SmallCParserPass2.conjunction_return conjunction()
			throws RecognitionException {
		SmallCParserPass2.conjunction_return retval = new SmallCParserPass2.conjunction_return();
		retval.start = input.LT(1);

		SmallCParserPass2.comparison_return comparison40 = null;

		SmallCParserPass2.y_conj_return y_conj41 = null;
	...
	public final SmallCParserPass2.y_conj_return y_conj(Node left)
			throws RecognitionException {
		SmallCParserPass2.y_conj_return retval = new SmallCParserPass2.y_conj_return();
		retval.start = input.LT(1);

		SmallCParserPass2.y_conj_return e = null;

		SmallCParserPass2.comparison_return comparison42 = null;

		SmallCParserPass2.comparison_return comparison43 = null;
	...
	public final SmallCParserPass2.equality_return equality()
			throws RecognitionException {
		SmallCParserPass2.equality_return retval = new SmallCParserPass2.equality_return();
		retval.start = input.LT(1);

		SmallCParserPass2.relation_return relation44 = null;

		SmallCParserPass2.relation_return relation45 = null;
	...
	public final SmallCParserPass2.comparison_return comparison()
			throws RecognitionException {
		SmallCParserPass2.comparison_return retval = new SmallCParserPass2.comparison_return();
		retval.start = input.LT(1);

		SmallCParserPass2.relation_return a = null;

		SmallCParserPass2.equality_return b = null;
	...
	public final SmallCParserPass2.relation_return relation()
			throws RecognitionException {
		SmallCParserPass2.relation_return retval = new SmallCParserPass2.relation_return();
		retval.start = input.LT(1);

		SmallCParserPass2.y_relation_return y_relation46 = null;

		SmallCParserPass2.sum_return sum47 = null;
	...
	public final SmallCParserPass2.y_relation_return y_relation()
			throws RecognitionException {
		SmallCParserPass2.y_relation_return retval = new SmallCParserPass2.y_relation_return();
		retval.start = input.LT(1);

		SmallCParserPass2.sum_return sum48 = null;

		SmallCParserPass2.sum_return sum49 = null;

		SmallCParserPass2.sum_return sum50 = null;

		SmallCParserPass2.sum_return sum51 = null;
	...
	public final SmallCParserPass2.sum_return sum() throws RecognitionException {
		SmallCParserPass2.sum_return retval = new SmallCParserPass2.sum_return();
		retval.start = input.LT(1);

		SmallCParserPass2.term_return term52 = null;

		SmallCParserPass2.y_sum_return y_sum53 = null;
	...
	// y_sum[$node] |);
	public final SmallCParserPass2.y_sum_return y_sum(Node left)
			throws RecognitionException {
		SmallCParserPass2.y_sum_return retval = new SmallCParserPass2.y_sum_return();
		retval.start = input.LT(1);

		SmallCParserPass2.y_sum_return e = null;

		SmallCParserPass2.term_return term54 = null;

		SmallCParserPass2.term_return term55 = null;
	...
	public final SmallCParserPass2.term_return term() throws RecognitionException {
		SmallCParserPass2.term_return retval = new SmallCParserPass2.term_return();
		retval.start = input.LT(1);

		SmallCParserPass2.factor_return factor56 = null;

		SmallCParserPass2.y_term_return y_term57 = null;
	...
	// y_term[$node] |);
	public final SmallCParserPass2.y_term_return y_term(Node left)
			throws RecognitionException {
		SmallCParserPass2.y_term_return retval = new SmallCParserPass2.y_term_return();
		retval.start = input.LT(1);

		SmallCParserPass2.y_term_return e = null;

		SmallCParserPass2.factor_return factor58 = null;

		SmallCParserPass2.factor_return factor59 = null;
	...
	public final SmallCParserPass2.factor_return factor() throws RecognitionException {
		SmallCParserPass2.factor_return retval = new SmallCParserPass2.factor_return();
		retval.start = input.LT(1);

		SmallCParserPass2.factor_return e = null;

		SmallCParserPass2.primary_return primary60 = null;
	...
	// pointer_id | '(' expr ')' );
	public final SmallCParserPass2.primary_return primary()
			throws RecognitionException {
		SmallCParserPass2.primary_return retval = new SmallCParserPass2.primary_return();
		retval.start = input.LT(1);
		...
		SmallCParserPass2.pointer_id_return pointer_id64 = null;

		SmallCParserPass2.expr_return expr65 = null;
	...
	public final SmallCParserPass2.pointer_id_return pointer_id()
			throws RecognitionException {
		SmallCParserPass2.pointer_id_return retval = new SmallCParserPass2.pointer_id_return();
		retval.start = input.LT(1);
		...
		Token READ68 = null;
		Token WRITE69 = null;
		SmallCParserPass2.primary_return e = null;

		SmallCParserPass2.expr_return a = null;

		SmallCParserPass2.expr_return b = null;

		SmallCParserPass2.id_check_return id_check70 = null;

		SmallCParserPass2.arg_list_return arg_list71 = null;

		SmallCParserPass2.array_operator_return array_operator72 = null;
			...
			// arg_list ')' )? ( array_operator[$node, $proptype, false] )?
			{
				...
				if (state.backtracking == 0) {
					if ((arg_list71 != null ? arg_list71.node : null) != null) {
						...
						String name = retval.name + "_call_";
						retval.node = new FunctionCallNode(stb.getByName(name).getID(), this.returnTypes.size());
						...
						CType func = stb.getByName(name).getNewType();
						...
						retval.node
								.appendChild((arg_list71 != null ? arg_list71.node
										: null));
						mustExist.add(stb.getByName(name).getID());
	...
	public final SmallCParserPass2.id_check_return id_check(boolean declaration)
			throws RecognitionException {
		SmallCParserPass2.id_check_return retval = new SmallCParserPass2.id_check_return();
		retval.start = input.LT(1);
			...
			// src/main/antlr3/compiler/Expr.g:1559:11: ID
			{
				...
				if (state.backtracking == 0) {
					...
					if (declaration) {
						...
						String name = (ID73 != null ? ID73.getText() : null);
						TableEntry entry = stb.getByName(name);
						if (!((entry.getDepth() != 0) || (entry.getNewType() instanceof FunctionType))){
							name += "_get_";
							retval.node = new FunctionCallNode(stb.getByName(name).getID(), this.returnTypes.size());
							retval.node.appendChild(new ArgsNode());
						} else {
							retval.node = new VarNode(entry.getID(), this.returnTypes.size(),
									false);
						}
