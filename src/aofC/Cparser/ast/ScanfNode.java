 ...
 * 
 * @file ScanfNode.java
 * @description This file contains the scanf node of the AST.
...
/**
 * 
 * This class represents a scanf node in an AST.
 * 
 **/
public class ScanfNode extends TypedNode {

	private static final long serialVersionUID = -3155606943668914289L;
	private int depth;

	public ScanfNode(int depth) {
		this.depth = depth;
	...
	public void toCode() {
		...
		CodeGenerator.insertCode("cup " + this.getSize() + " l_scan");
	}
